...
$inbox = $inboxDataSource->getInboxMessages(CookieClient::getUserId(), $fromDate, $toDate);
...
<?php $pageKey = PageKey::$MESSAGE_INBOX;
include '../Include/menu_client.php'; ?>
                        </ul>
                    </div>
                    <!-- /.sidebar-collapse -->
                </div>
