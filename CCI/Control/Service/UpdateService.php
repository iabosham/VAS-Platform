...
$errflag = false;
 ...
 try{
       ...
       $isUpdated = ServiceControl::updateService($id,$serviceName,$serviceTypeID, $serviceKey,$shortcodeID, Cookie::getUserId(),$subMessage,$unSubMessage,$senderName,$freeSource,$method) ;
