                    ...
                    ?>
                            ...
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                ...
                                <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                    <form class="form-horizontal" action="../../Control/User/Chan_password.php" method="post">
                                        <fieldset>
                                            <legend>Change User Password</legend>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="focusedInput">Name</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="name" type="text" readonly value="<?php echo $userInfo['name']; ?>" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input  class="form-control" id="focusedInput" name="login" type="text" readonly value="<?php echo $userInfo['login']; ?>" >
                                                </div>
                                            </div>
