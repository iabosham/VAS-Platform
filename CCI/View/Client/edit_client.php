                        ...
                        <?php  include '../Include/error_message.php';  ?>
                            ...
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                ...
                                <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                    <form class="form-horizontal" action="../../Control/Client/UpdateClient.php" method="post">
                                        <fieldset>
                                            <legend>Update Client</legend>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="focusedInput">Name</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="name" type="text" value="<?php echo $clientInfo['name']; ?>" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="login" type="text" value="<?php echo $clientInfo['login']; ?>" >
                                                </div>
                                            </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="email" type="text" value="<?php echo $clientInfo['email']; ?>" >
                                                </div>
                                            </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="phone" type="text" value="<?php echo $clientInfo['phone']; ?>" >
                                                </div>
                                            </div>
                                          
              
                                            <button style="float: right;" type="submit" class="btn btn-primary">Edit Client</button>
