                        ...
                        <div class="col-lg-12">
                            <div class="page-header bootstrap-admin-content-title">
                                ...
                                <a href="index.php" class="action">
                                    <button class="btn btn-success">Clients View</button>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    ?>
                            ...
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">Form Client</div>
                                </div>
                                <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                    <form class="form-horizontal" action="../../Control/Client/AddClient.php" method="post">
                                        <fieldset>
                                            <legend>Register Client</legend>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="focusedInput">Client's name</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="name" type="text" placeholder="Enter client's name here ..." >
                                                </div>
                                            </div>
                                            
                                              <div class="form-group has-feedback">
                                                <label class="col-lg-2 control-label" for="selectError">Vendor</label>
                                                <div class="col-lg-10">
                                                    <select id="selectError" class="form-control" name="vendorID">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="login" type="text" placeholder="Enter username here...">
                                                </div>
                                            </div>
                                            
                                              <div class="form-group">
                                                    <label class="col-lg-2 control-label" for="focusedInput">Secret</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="secret" type="password" placeholder="Enter secret key here...">
                                                </div>
                                            </div>
                                            
                                              <div class="form-group">
                                                <label class="col-lg-2 control-label" for="focusedInput">Re-secret</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" type="text" placeholder="Enter secret key again...">
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="email" type="text" placeholder="Enter client email here...">
                                                </div>
                                            </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="phone" type="text" placeholder="Enter client's phone here...">
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <label>
                                                        <input type="checkbox" id="optionsCheckbox2" name="isActive" value="1" checked=""  >
                                                       Active
                                                    </label>
                                                </div>
                                            </div>
