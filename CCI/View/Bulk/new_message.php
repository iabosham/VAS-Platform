                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="../../Control/ContentMessage/AddContentMessageAdmin.php" method="post">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <select class="form-control" name="contentType" >
                                                <option onclick="contentTypeCheck(1);" value="1">Single</option>
                                                <option onclick="contentTypeCheck(2);" value="2">Bulk</option>
                                      ...
                                      <div class="form-group">
                                            <label>Ex:</label>
<textarea class="form-control" readonly rows="3" name="exp">
