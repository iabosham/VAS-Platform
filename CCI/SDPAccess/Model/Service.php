...
class Service extends DBConnection {
    ...
    public function getServicesData($companyId) {
         $where = ""; 
         if($companyId > 0){
            
            $where.= " and shortcode.company_id = $companyId " ;
        }
         $qry = "select service.id,service.name as serviceName,service.service_code,service.service_key,service.unsub_key,"
                ...
                . "from service,service_type,shortcode,vendor,operators "
                 . "where service.type = 1 and service.shortcode_id=shortcode.id and shortcode.company_id=operators.id and "
