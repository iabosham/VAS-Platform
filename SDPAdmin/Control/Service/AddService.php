...
try {
    ...
    $serviceId = ServiceControl::AddService($serviceName, $serviceTypeID, $serviceKey, $shortcodeID
                    , Cookie::getUserId(), $subMessage, $unSubMessage, $senderName, $freeSource, $method, $subServiceId, $systemId, $senderInfo, $typeId,12,1);
