...
function getShortcodesByCompanyId(comId,divId)
{
    var xmlHttp = getXMLHttp();
    ...
    xmlHttp.open("GET", "../Ajax/GetShortcodesByCompanyId.php?companyId=" + comId, true);
    xmlHttp.send();
}


function getServicesByShortcodeId(shortcodeId,divId)
{
    var xmlHttp = getXMLHttp();
    ...
    xmlHttp.open("GET", "../Ajax/GetServicesByShortcodeId.php?shortcodeId=" + shortcodeId, true);
    xmlHttp.send();
}
...
function hasData(id)
{
     ...
     if (id  === 3 ) {
         ...
         document.getElementById("urlInfo").style.visibility="hidden";  
         document.getElementById("urlInfo").style.display="none";  
         document.getElementById("autoCompleteInfo").style.visibility="hidden";  
         document.getElementById("autoCompleteInfo").style.display="none";  
         
         
      }else if (id  === 5){
         document.getElementById("urlInfo").style.visibility="visible";  
        ...
        document.getElementById("autoCompleteInfo").style.display="none";  
         ...
         document.getElementById("autoCompleteInfo").style.visibility="visible";  
         document.getElementById("autoCompleteInfo").style.display="block"; 
