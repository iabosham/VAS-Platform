...
require_once('../../SDPAccess/Model/MessageQueue.php');
require_once('../../SDPAccess/AccessControl/MessageQueue/MessageQueueControl.php');
...
$messages = MessageQueueControl::getQueueMessageCounts($fromDate, $toDate, $companyId);
...
<?php $pageKey = PageKey::$PAGE_QUEUE;
                                ...
                                <div class="panel-body">
                                    ...
                                    if ($messages != null) {
                                        ...
                                        <table width="100%" class="table table-striped table-bordered table-hover"  >
                                            ...
                                            <?php }else { ?> <h5>Queue is empty</h5> <?php } ?>
                                    <!-- /.table-responsive -->
