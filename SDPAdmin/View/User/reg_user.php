                        ...
                        <?php  include '../Include/session_message.php';  ?>
                            ...
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                ...
                                <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                    <form class="form-horizontal" action="../../Control/User/AddUser.php" method="post">
                                        <fieldset>
                                            <legend>Register new user</legend>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="focusedInput">Name</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="name" type="text" placeholder="Enter user name value here ..." >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="login" type="text" placeholder="Enter login value here ..." >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="password" type="password" placeholder="Enter secret value here ..." >
                                                </div>
                                            </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="email" type="text" placeholder="Enter email value here ..." >
                                                </div>
                                            </div>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="phone" type="text" placeholder="Enter phone value here ..." >
                                                </div>
                                            </div>
                                          
              
                                            <button style="float: right;" type="submit" class="btn btn-primary">Add User</button>
