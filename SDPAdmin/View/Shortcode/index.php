...
$services = ShortcodeControl::getShortcodes(Cookie::getCompanyID());
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">   Services
                            <a  href="reg_shortcode.php" class="btn btn-primary"  style="float: right;"> Add Service  </a>
                        </h1>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                         ...
                                         <td><a href="../Service/index.php?serviceId=<?php echo $row['id'] ?>" class="btn btn-link " style="padding: 0px;" > Sub Services </a></td>
                                         </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
