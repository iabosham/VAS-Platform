                        ...
                        <div class="col-lg-12">
                            <div class="page-header bootstrap-admin-content-title">
                                ...
                                <a href="index.php" class="action">
                                    <button class="btn btn-success">Transceiver's view</button>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    ?>
                            ...
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">Form Transceiver</div>
                                </div>
                                <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                    <form class="form-horizontal" action="../../Control/Trans/AddTrans.php" method="post">
                                        <fieldset>
                                            <legend>Register Transceiver</legend>
                                            
                                               <div class="form-group">
                                                <label class="col-lg-2 control-label" for="focusedInput">Trans ID</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="id" type="text"   >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control" id="focusedInput" name="title" type="text"  >
                                                </div>
                                            </div>
