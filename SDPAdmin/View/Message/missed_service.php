...
$messages = MessageControl::getUnpushedMessages($serviceId, $fromDate, $toDate,$companyId);
...
<head>
    ...
    <title>Management - Unpushed Content  </title>
    ...
    <div id="wrapper">
          ...
          <?php include '../Include/main_header_1.php'; ?>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                   <?php $pageKey = PageKey::$PAGE_MISSED_SERVICE; include '../Include/menu.php'; ?>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
        </div>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Unpushed Content
                            <a  href="#" class="btn btn-primary"  style="float: right;"> Add Content  </a>
                        </h1>
                        
                        <?php include '../Include/session_message.php'; ?>

                        <form   action="missed_service.php" method="get">
