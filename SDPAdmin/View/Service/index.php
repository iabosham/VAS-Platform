...
$shortcodeId = General::cleanGet("serviceId");
$services = ServiceControl::getServices($shortcodeId, Cookie::getCompanyID());
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sub Services
                            <a  href="reg_service.php" class="btn btn-primary"  style="float: right;"> Add Sub Service  </a>
                        </h1>
