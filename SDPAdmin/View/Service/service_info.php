...
$sendingTimes = SendingTimeControl::getSendingTimesInfo($id);
...
<html lang="en">
                                       ...
                                       <table class="table" style="direction: ltr;text-align: left;">
                                         ...
                                         <tr>
                                            ...
                                            <tr class="warning">
                                             ...
                                             <tr class="warning">
                                                <td>Un-sub Key</td>
                                                <td><?php echo $serviceInfo['unsub_key']; ?></td>
                                       ...
                                       <?php } ?>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th colspan="3" >Sending Time</th>
                                               
                                            </tr>
                                            
                                            <tr style="padding: 15px;" >
                                        <form action="../../Control/SendingTime/AddSendingTime.php" method="post">
                                            <input type="hidden" name="shortcodeId" value="<?php echo $id ; ?>" />
                                                 ...
                                                 <th>
                                                     Order Id: <input  name="order" style="width: 100px;" type="number" />
                                                 </th>
                                                     ...
                                                     <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                        ...
                                                        <tbody>
                                                         ...
                                                         if($sendingTimes != null){
                                                             ...
                                                             foreach($sendingTimes as $sendingTime){ 
                                                                 
                                                               echo '<tr><td>' ;
                                                                echo $sendingTime['order_id'] ;
                                                               echo '</td><td>' ;
                                                                echo $sendingTime['send_time'] ;
                                                               echo '</td></tr>' ;
                                        ...
                                        <form action="../../Control/ReSendConfig/AddConfig.php" method="post">
                                            <input type="hidden" name="shortcodeId" value="<?php echo $id ; ?>" />
                                                 <th style="border: 0px;float: left;">
                                                     <input type="hidden" name="serviceID" value="<?php echo $serviceInfo['id']; ?> " />
                                                     Time: <input  name="time" readonly="" style="width: 100px;" id="datetimepicker2"  type="text"  />
                                                 </th>
  ...
  <script src="../../js/datetimepicker/jquery2.js"></script>
        ...
        $i('#datetimepicker2').datetimepicker({datepicker:false,format:'H:i:s'});
          </script>
