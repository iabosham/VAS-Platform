   ...
   public static function setId($id){
    ...
    public static function setLogin($login){
     ...
     public static function setCompanyID($id){
         setcookie("SDPS66",$id,time()+60*60*24*30,'/');
    }
    
       public static function setCompanyName($name){
         setcookie("SDPS77",$name,time()+60*60*24*30,'/');
    }
    ...
    public static function getUserLogin(){
      ...
      public static function getSystemID(){
       ...
       public static function getCompanyID(){
        return $_COOKIE["SDPS66"] ; 
    }
    
       public static function getCompanyName(){
           
           if(isset($_COOKIE["SDPS77"])){
                 return $_COOKIE["SDPS77"] ; 
           }  else {
              return "Unknown"; 
           }
     ...
     public static function removeCookies(){
       ...
       setcookie("SDPS66", "",time()-60*60*24*30,'/');
       setcookie("SDPS77", "",time()-60*60*24*30,'/');
