  ...
  function __construct() {
    ...
    try {
      ...
      $stmt = $this->connection->prepare("select client.id ,client.name,client.user_type,client.is_admin,"
              . "vendor.name as vendorName,vendor.id as vendorId ,vendor.public_key from client,vendor where client.isActive =1 and client.login = ? and client.secret = ? and client.vendor_id=vendor.id ");
