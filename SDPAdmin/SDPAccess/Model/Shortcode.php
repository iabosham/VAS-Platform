...
class Shortcode extends DBConnection{
  ...
  function __construct() {
    ...
    public  function addShortcodeData($title ,$code,$vendorID,$userID,$companyId){
      $add_qry = "insert into shortcode (title,number,vendor_id,user_id,company_id) "
              . " values('$title','$code','$vendorID','$userID',$companyId) " ;
      ...
      public  function getShortcodesData($companyId){
          $where = "";
      ...
      $qry = "select shortcode.id,shortcode.title,shortcode.number,vendor.name as vendorName,operators.name as companyName,"
              . "user.name as userName  "
              . "from shortcode,vendor,user,operators "
              . "where shortcode.company_id= operators.id and operators.status = 1 and shortcode.vendor_id = vendor.id and shortcode.user_id=user.id $where " ;
      ...
      $qry = "select shortcode.id,shortcode.title,shortcode.number,shortcode.isActive"
              . ",user.name as userName,shortcode.company_id"
