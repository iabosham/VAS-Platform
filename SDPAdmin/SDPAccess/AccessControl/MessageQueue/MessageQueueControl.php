...
class MessageQueueControl extends MessageQueue{
   ...
   public static function getQueueMessageCounts($fromDate, $toDate, $companyId){
       $messageQueueObj = new MessageQueue();
       $result = $messageQueueObj->getQueueMessageCountsData($fromDate, $toDate, $companyId);
       $messageQueueObj->close();
       return $result;
