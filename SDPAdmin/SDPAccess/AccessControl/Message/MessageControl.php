...
class MessageControl extends Message{
   ...
   return $messageTypeObj->getMessagesByVendorData($vendorID, $fromDate, $toDate);
    ...
    public static function getMessages($serviceId, $fromDate, $toDate,$companyId=0){
       $messageTypeObj = new Message();
   return $messageTypeObj->getMessagesData($serviceId, $fromDate, $toDate,$companyId);
   
   }
   
     public static function getUnpushedMessages($serviceId, $fromDate, $toDate,$companyId){
       $messageTypeObj = new Message();
   return $messageTypeObj->getUnpushedMessagesData($serviceId, $fromDate, $toDate,$companyId);
   ...
   return $messageTypeObj->updateMessageStatusData($messageID, $status) ;
        ...
        public static function updateTextAndStatus($messageID,$status ,$msg){
       $messageTypeObj = new Message();
   return $messageTypeObj->updateTextAndStatusData($messageID, $status, $msg);
   }
